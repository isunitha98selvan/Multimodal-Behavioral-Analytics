...
def mid_feature_extraction_to_file(file_path, mid_window, mid_step,
    ...
    if store_short_features:
        ...
        if plot:
            ...
            print("Error in creating numpy file")
        if store_csv:
    ...
    # np.save(output_file + "P1_wav_mt", mid_features)
    # if plot:
    #     print("Mid-term np file: " + output_file + "P1_wav_mt.npy saved")
    # if store_csv:
    #     np.savetxt(output_file + "P1_wav_mt.csv", mid_features.T, delimiter=",")
    #     if plot:
    #         print("Mid-term CSV file: " + output_file + "P1_wav_mt.csv saved")
